...
public class NoticeController {
  ...
  public String edit(int noticeId, Model model) {
    Map<String, Object> map = noticeService.getNoticeById(noticeId);
    model.addAttribute("notice", map.get("n"));
    model.addAttribute("attachList", map.get("attachList"));
    return "notice/correction";
  }
  ...
  public String modify(NoticeDto noticeDto
                     ...
                     , MultipartHttpServletRequest mutlipartRequest) {
    redirectAttributes.addFlashAttribute("msg", noticeService.modifyNotice(noticeDto, mutlipartRequest));
    return "redirect:/notice/list.do";
  }
  ...
  @RequestMapping(value="/removeAttaches.do", method=RequestMethod.POST)
  public String removeAttaches(String noticeId, String[] attachIds
                             , RedirectAttributes redirectAttributes
                             , MultipartHttpServletRequest multipartRequest
                             ) {
    redirectAttributes.addFlashAttribute("msg", noticeService.removeAttach(attachIds));
